#!/usr/bin/env python3
"""
Hard-coded Secrets & High-Risk Strings Scanner
Performs deterministic regex scans for common secret patterns
"""
...
class SecretScanner:
    def __init__(self):
        ...
        self.patterns = {
            ...
            'encrypted_keys_dotnet': {
                'pattern': r'CfDJ8[a-zA-Z0-9/+=_-]+',
                'description': '.NET Core Data Protection encrypted strings'
            }
        }
    ...
    def save_to_csv(self, findings: List[Dict[str, Any]], output_file: str = 'hardcoded-secrets.csv'):
        ...
        fieldnames = ['file', 'line', 'pattern', 'description', 'sample', 'category', 'context']
...
def main():
    ...
    with open('hardcoded-secrets-detailed.json', 'w') as f:
        json.dump(findings, f, indent=2, default=str)
    
    print(f"\nDetailed results also saved to hardcoded-secrets-detailed.json")
